        ...
        <div class="container py-5">
            ...
            <div class="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-2">
                <div class="col" v-for="(service, index) in services" :key="index">
                    <router-link :to="'/service-sentence/' + service.name" class="card text-decoration-none text-white" style="background-color: black !important;">
                        <div class="d-flex justify-content-center align-items-center py-2">
                            <div class="border rounded-circle p-3 px-4" style="border-color: var(--brand-color) !important;">{{ index + 1 }}</div>
                        </div>
                        <div class="card-body">
